...
const Terms = () => {
  return (
    <div>
      <MetaData title="Terms &amp; Conditions | www.partyondoor.com" />
      <div className="px-10 mt-5 mb-5">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to www.partyondoor.com!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Blashio&apos;s Website, located at www.partyondoor.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use www.partyondoor.com if you do not
        ...
        <p>
          We employ the use of cookies. By accessing www.partyondoor.com, you
        ...
        <p>
          ...
          intellectual property rights for all material on www.partyondoor.com.
          All intellectual property rights are reserved. You may access this
          from www.partyondoor.com for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from www.partyondoor.com</li>
          <li>Sell, rent or sub-license material from www.partyondoor.com</li>
          <li>Reproduce, duplicate or copy material from www.partyondoor.com</li>
          <li>Redistribute content from www.partyondoor.com</li>
        </ul>
        ...
        <p>
          ...
          sending an e-mail to <b>contact.awecasion@gmail.com</b>. Please include your
